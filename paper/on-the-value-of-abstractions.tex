...
Figure~\ref{fig:abstraction-selection} lays out this comparison; the two
paths differ only in the selection objective and the data it consults.
...
Selection itself has a cost, and the two selectors pay different amounts.
